...
# Example usage
I_color = cv2.imread('dogorig.jpeg')
W_color = cv2.imread('dimwatermark.png')
...
FI_color = cv2.imread('dogforg.png')
if FI_color is None:
...
if np.all(FRM_combined == 0):
    ...
    print(FRM_combined)
image1 = cv2.imread('dogorig.jpeg', cv2.IMREAD_GRAYSCALE)
image2 = cv2.imread('watermarked_image_color.png', cv2.IMREAD_GRAYSCALE)
